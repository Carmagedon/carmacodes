...
<footer class="page-footer">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-4">
                ...
                <h5 class="white-text">Sociálne siete</h5>
                <ul class="page-footer__links">
                    <li>
                        <a target="_blank"  rel="noopener" href="https://www.facebook.com/andrej.carma.szabo">
                    ...
                    <li><a target="_blank" rel="noopener" href="https://www.instagram.com/c4rm4gg3d0n/">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="#fff">
                                <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"/>
                            </svg>
                            Instagram</a></li>
                    <li><a target="_blank" rel="noopener" href="https://github.com/Carmagedon">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="18" fill="#fff">
            ...
            <div class="col-12 col-lg-4">
                <h5 class="white-text">Vlastné projekty</h5>
                <ul>
                    <li><a target="_blank" rel="noopener" href="https://carmahost.com">Carmahost.com</a></li>
                </ul>
            </div>
        </div>
    </div>
    <div class="footer-copyright">
        <div class="container">
	        <?php echo get_field('copy_text','options').' '. date("Y") ?>
        </div>
    </div>
</footer>
<?php wp_footer(); ?>
