...
/// COOPY MATERIALIZE /////////////
    gulp.src( paths.node + 'materialize-css/sass/**/*.scss' )
        .pipe( gulp.dest( paths.dev + '/sass/materialize-css' ) );
    gulp.src( paths.node + 'materialize-css/dist/js/**/*.js' )
        .pipe( gulp.dest( paths.dev + '/js/materialize-css' ) );
/// END MATERIALIZE ////////////////
